...
$routes->get('/clientes', ['uses' => 'ClientesController@getClientePorId']);
...
$routes->get('/menu', ['uses' => 'MenusController@getMenuPorId']);
...
$routes->get('/negocios', ['uses' => 'NegociosController@getNegocioPorId']);
...
$routes->get('/pedidos', ['uses' => 'PedidosController@getPedidoPorId']);
...
$routes->get('/platillo', ['uses' => 'PlatillosContoller@getPlatilloPorId']);
